import { Component, inject, ElementRef, viewChild, afterNextRender, OnDestroy } from '@angular/core';
          ...
          @for (exp of experiences; track exp.company + exp.period; let i = $index) {
            <div class="timeline-item" [class.left]="i % 2 === 0" [class.right]="i % 2 !== 0">
              ...
              <div class="timeline-content">
                ...
                <p class="description">{{ translate.isPortuguese() ? exp.description_pt : exp.description_en }}</p>

                @if ((translate.isPortuguese() ? exp.highlights_pt : exp.highlights_en).length > 0) {
                  <ul class="highlights">
                    @for (h of (translate.isPortuguese() ? exp.highlights_pt : exp.highlights_en); track h) {
                      <li>{{ h }}</li>
                    }
                  </ul>
                }
...
export class ExperienceComponent implements OnDestroy {
  ...
  private initCodeRain() {
    ...
    const keywords = [
      'class', 'public', 'void', 'int', 'string', 'bool', 'var', 'const',
      'let', 'async', 'await', 'return', 'new', 'this', 'if', 'else',
      'for', 'while', 'try', 'catch', 'using', 'namespace', 'import',
      'export', 'interface', 'enum', 'static', 'override', 'abstract',
      'SELECT', 'FROM', 'WHERE', 'INSERT', 'UPDATE', 'DELETE', 'JOIN',
      'docker', 'build', 'push', 'deploy', 'run', 'kubectl', 'apply',
      '=>', '{}', '()', '[]', '&&', '||', '!=', '==', '<<', '>>',
      'C#', '.NET', 'Angular', 'Azure', 'SQL', 'API', 'REST', 'Git',
      '0', '1', 'true', 'false', 'null', 'Task', 'List', 'IService'
    ];
    const fontSize = 13;
    let columns: number;
    let drops: number[];
  ...
  experiences: Experience[] = [
    {
      ...
      location: 'Remoto',
      description_pt: 'Atuei como Lider Tecnico em um ecossistema complexo de securitizacao, gerenciando um sistema legado critico e direcionando o time para praticas modernas de desenvolvimento.',
      description_en: 'Acted as Tech Lead in a complex securitization ecosystem, managing a critical legacy system and directing the team towards modern development practices.',
    ...
    },
    {
      ...
      description_pt: 'Empresa de consultoria de desenvolvimento e outsourcing atuando com diversas tecnologias em projetos de meio de pagamento, servicos bancarios, mobilidade urbana e e-commerce.',
      description_en: 'Development consulting and outsourcing company working with various technologies in payment, banking services, urban mobility and e-commerce projects.',
    ...
    },
    {
      ...
      description_pt: 'Tech Lead Full Stack Developer no time Scan, focado em melhores praticas de desenvolvimento, colaboracao entre times e inovacao com IA.',
      description_en: 'Tech Lead Full Stack Developer in the Scan team, focused on best development practices, team collaboration, and AI innovation.',
    ...
    },
    {
      ...
      location: 'Remoto',
      description_pt: 'Desenvolvimento de robos de automacao usando SAP Gui para a Ericsson, criacao de robos de extracao para prefeituras e projeto Sinqia com Cosmos DB.',
      description_en: 'Development of automation robots using SAP Gui for Ericsson, creation of extraction robots for municipalities, and Sinqia project with Cosmos DB.',
    ...
    },
    {
      ...
      description_pt: 'Treinamento de equipe em SOLID, Clean Code, CQRS, TDD e DDD. Arquitetura Hexagonal com RabbitMQ, Docker no GCP e Kubernetes.',
      description_en: 'Team training in SOLID, Clean Code, CQRS, TDD and DDD. Hexagonal architecture with RabbitMQ, Docker on GCP and Kubernetes.',
    ...
    },
    {
      ...
      description_pt: 'Manutencao de sistema legado, novas funcionalidades e suporte em normas de chargeback (CBK) e disputas no setor financeiro.',
      description_en: 'Legacy system maintenance, new features and support in chargeback (CBK) standards and disputes in the financial sector.',
    ...
    },
    {
      ...
      description_pt: 'Manutencao e reestruturacao de sistemas legados para .NET Core, processamento de transacoes no mercado de pagamentos (gateway).',
      description_en: 'Legacy system maintenance and restructuring to .NET Core, transaction processing in payment gateway market.',
    ...
    },
    {
      ...
      description_pt: 'Diretor responsavel pelo projeto Pag24horas - sistema de pagamento eletronico. Atuando como desenvolvedor, DBA, analista, gerente de projetos, lider e Scrum Master.',
      description_en: 'Director responsible for the Pag24horas project - electronic payment system. Acting as developer, DBA, analyst, project manager, leader and Scrum Master.',
    ...
    },
    {
      ...
      location: 'Espirito Santo, Brasil',
      description_pt: 'Vice-lider da equipe Assinatura no projeto V1, sistema de assinatura de veiculos automotivos do Grupo Aguia Branca.',
      description_en: 'Vice-leader of the Subscription team in the V1 project, automotive vehicle subscription system for Grupo Aguia Branca.',
      techs: ['C#', '.NET Core 3.1', '.NET 5', 'Angular', 'SQL Server', 'Redis', 'Azure Service Bus', 'DDD'],
      highlights_pt: [],
      highlights_en: []
    },
    {
      ...
      description_pt: 'Manutencao de aplicacoes, automacao de processos, levantamento de custos e planejamento de solucoes de TI.',
      description_en: 'Application maintenance, process automation, cost analysis and IT solutions planning.',
